...
@include('components.navbar')
  <section class="container my-24 mx-auto p-5 relative">
    <div class="absolute top-20 left-0 w-full flex justify-center">
      <a href="{{ route('product.add') }}" class="inline-block bg-green-600 text-white px-4 py-2 rounded-lg mx-auto hover:bg-opacity-80 hover:-translate-y-1 transition-all duration-300">Tambah Produk</a>
    </div>
